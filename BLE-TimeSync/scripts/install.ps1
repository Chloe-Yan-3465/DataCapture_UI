...
if (-not $PythonExe) {
    throw "Python 3.11 or 3.12 (64-bit) was not found. Obtain installation approval before installing it."
}
...
Write-Host "No system-wide Python configuration was changed."
